...
async function redeSociaisFavoritasMinhaEscola(){
...
const dacdos = await res.json()

const redeSociais = dados.slice(1).map(redes => redes[1])
...
redeSociaisFavoritasMinhaEscola()
